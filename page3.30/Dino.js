...
{
  modal.innerHTML='<div class="modalPopup" contenteditable="false"><span class="close" contenteditable="true" onkeydown="alert("hello");" onclick="closeModal()">X</span><div class="content"><object id="video" width="420" height="315" data="'+vidObj[x].video+'"></object><div class="modalInformation"><div class="infoTitle">'+vidObj[x].title+'</div><div class="infoSynop">'+vidObj[x].synop+'</div></div></div>';
